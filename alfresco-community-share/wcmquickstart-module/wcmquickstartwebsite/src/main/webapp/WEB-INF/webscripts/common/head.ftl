...
<script type="text/javascript" src="${url.context}/js/jquery-1.12.4.min.js"></script>
<script type="text/javascript" src="${url.context}/js/jqueryslidemenu.js"></script>
<script type="text/javascript" src="${url.context}/js/jquery-ui-1.12.1.min.js"></script>
